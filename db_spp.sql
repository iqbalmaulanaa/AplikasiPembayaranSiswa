...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Sep 2020 pada 09.08
...
ALTER TABLE `pembayaran`
  ...
  ADD UNIQUE KEY `foreign_siswa` (`nisn`) USING BTREE,
  ADD KEY `foreign_petugas` (`id_petugas`),
  ADD KEY `foreign_spp` (`id_spp`);
...
ALTER TABLE `siswa`
  ...
  ADD UNIQUE KEY `foreign_kelas` (`id_kelas`) USING BTREE,
  ADD UNIQUE KEY `foreign_spp` (`id_spp`);
